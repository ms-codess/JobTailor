...
- Extract languages into the 'languages' array.
 - Extract links as {label, url} pairs only when a full URL is present in the text (e.g., https://...). Do NOT invent URLs. If only a label like "LinkedIn" is present without a URL, omit it entirely.
